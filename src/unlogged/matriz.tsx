...
const CloseIcon = () =>
    <SvgIcon>
        <path d={materialIoIconsSvgPath.Close} />
    </SvgIcon>

const InfoIcon = () =>
    <SvgIcon>
        <path d={materialIoIconsSvgPath.Info} />
    </SvgIcon>
...
const WarningIcon = () =>
    <SvgIcon>
        <path d={materialIoIconsSvgPath.Warning} />
    </SvgIcon>
...
function SearchAppBar(props: { dimensiones:Dimension[], search:string|null, onSearch: (value: string) => void }) {
                ...
                <AppBar>
                    <Toolbar>
                        ...
                        <Typography className={classes.title} variant="h6" noWrap>
                            Banco de Datos
                            <img class="local-logo" src="./storage/local-logo.png" />
                        </Typography>
...
function AppMiniRepo(props:{dimensiones:Dimension[]}){
    ...
    return <React.StrictMode>
        ...
        <div className="matriz-comparacion">
            <SearchAppBar dimensiones={props.dimensiones} search={search} onSearch={searchChange}/>
